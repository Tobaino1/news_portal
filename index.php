                    ...
                    <div class="col-12 col-lg-7">
                        <div class="single-blog-post featured-post">
                            ...
                            <div class="post-data">
                                ...
                                <a href="#" class="post-title">
                                    <button type="button" onclick="show1('id1');">Read news...</button>
                                    <div id="id1" style="display:none">
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="image_upload/<?php echo $image ?>" width="170" height="120">
                                            </td>
                                            <br>
                                            <td>Headline: <strong
                                                        style="color: black"> <?php echo $headline; ?></strong></td>
                                            <br>
                                            <button onclick="myFunction1()">Show / Hide most recent news ...</button>
                                            <div id="myDIV1">
                                                <script>
                                                ...
                                                <br>
                                                <td>&nbsp;By: <?php echo $reporter_name; ?> </td>
                                                <br>
                                                <td>&nbsp;Headline: <?php echo $headline; ?> </td>
                                                <br>
                                                <td><?php echo $content; ?> </td>
                                                <br>
                                                <p>more pictures below</p>
                                                <td><img src="img1/<?php echo $files; ?>" width="180"
                                                         height="100"></td>
                                                <br>
                                                <td><img src="img2/<?php echo $image2; ?>" width="180"
                                                         height="100"></td>
                                                <br>
                                                <td><img src="img3/<?php echo $image3; ?>" width="180"
                                                         height="100"></td>
                                                <br>
                                                <td><img src="img4/<?php echo $image4; ?>" width="180"
                                                         height="100"></td>
                                                <br>
                                                <td><img src="img5/<?php echo $image5; ?>" width="180"
                                                         height="100"></td>
                                        </tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="fb-share-button" data-href="https://lagosreporters9ja.com"
                                             data-layout="button_count" data-size="small"><a target="_blank"
                                                                                             href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Flagosreporters9ja.com%2F&amp;src=sdkpreparse"
                                                                                             class="fb-xfbml-parse-ignore">
                                    <td><span><i class="fa fa-facebook" style="color: blue"></i></span></td>
                                    Share via Facebook</a></div>


                            </td>
                                            <td>
                                                <span><i class="fa fa-whatsapp" style="color: green"></i></span>
                                                <a href="whatsapp://send?text=https://www.lagosreporters9ja.com">Share
                                                    via WhatsApp</a>
                                            </td>
                            <br>
                            <td><span><i class="fa fa-twitter" style="color: blue"></i></span></td>
                            <a href="https://platform-api.sharethis.com/js/sharethis.js#property=5dac7a5c6597dd0019b239d2&product=inline-share-buttons">
                                Share via Twitter<a>
                                    <br>
                                </a>
                                <br><Br>
            ...
            <div class="col-12 col-lg-5">
                ...
                <div class="single-blog-post featured-post-2">
                    ...
                    <div class="post-data">
                        ...
                        <div class="post-meta">
                            <a href="#" class="post-title">
                                <button type="button" onclick="show2('id2');">Read news...</button>
                                    ...
                                    $image = $row['image'];
                                        ...
                                        <tr>
                                            ...
                                            <td>Headline: <strong
                                                        style="color: black"> <?php echo $headline; ?></strong></td>
                                            <br>
                                            <button onclick="myFunction2()">Show / Hide most recent news ...</button>
                                            <div id="myDIV2">
                                                <script>
                        ...
                        <td>
                            <span><i class="fa fa-whatsapp" style="color: green"></i></span>
                            <a href="whatsapp://send?text=https://www.lagosreporters9ja.com">Share via WhatsApp</a>
                        </td>
                        <br>
                        <td><span><i class="fa fa-twitter" style="color: blue"></i></span></td>
                        <a href="https://platform-api.sharethis.com/js/sharethis.js#property=5dac7a5c6597dd0019b239d2&product=inline-share-buttons">
